...
//		EmployeeRepository employeeRepository = context.getBean(EmployeeRepository.class);
		...
		Employee employee3 = new Employee("Fırat", "Ay", 2000, department3);
		Employee employee4 = new Employee("Selim", "Hamzaoğulları", 3000, department4);
		Employee employee5 = new Employee("Emre", "Yılmaz", 4000, department1);
